## Summary
This project is a set of exercises done during the NSS Data Analytics Bootcamp, when first learning SQL.

All answers are included in the script (wouldn't want to spoil anyone's attempt to try it by giving away the answers!)
